...
class Voga_Sizetables_Block_Adminhtml_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree  {
    ...
    {
        parent::__construct();
        $this->setTemplate('voga_sizetables/categories.phtml');
        $this->_withProductCount = false;
    }

    public function getCategoryIds()
    {
        $sizetableId = $this->getRequest()->getParam('entity_id', false);
        return Mage::getModel('voga_sizetables/sizetables')->getSizetablesCategoriesIds($sizetableId);
    }
